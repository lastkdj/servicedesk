      ...
      <AccordionDetails classes={{ root: classes.root }}>
        <Grid container item xs={12} alignItems="center">
          <Button classes={{ root: classes.buttonlist }}>
            ...
            >
              <Typography className={classes.menutext}>Charts</Typography>
            </Grid>
          </Button>
          <Divider />
          <Button
          ...
          >
            <Grid
              ...
              style={{ paddingLeft: "45px" }}
            >
              <Typography className={classes.menutext}>Departments</Typography>
            </Grid>
          </Button>
          <Divider />
          <Button
          ...
          >
            <Grid
              ...
              style={{ paddingLeft: "45px" }}
            >
              <Typography className={classes.menutext}>Job Sites</Typography>
            </Grid>
          </Button>
        </Grid>
      </AccordionDetails>
