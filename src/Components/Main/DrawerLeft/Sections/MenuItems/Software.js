...
import microsoftofficeIcon from "@iconify/icons-simple-icons/microsoftoffice";
      ...
      <AccordionDetails classes={{ root: classes.root }}>
        <Grid container item xs={12} alignItems="center">
          <Button classes={{ root: classes.buttonlist }}>
            ...
            >
              <Typography className={classes.menutext}>Office 365</Typography>
              <Icon
          ...
          >
            <Grid
              ...
              style={{ paddingLeft: "45px" }}
            >
              <Typography className={classes.menutext}>Autodesk</Typography>
              <Icon
                icon={designLine}
                className={classes.menuicon}
                style={{ fontSize: "1.7em", margin: "0 10px" }}
